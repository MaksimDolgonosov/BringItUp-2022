...
window.addEventListener("DOMContentLoaded", function () {
  ...
  slider.render();
  var moduleSlider = new _modules_slider_mainslider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    page: ".moduleapp",
    btns: ".next",
    prevBtn: ".prevmodule",
    nextBtn: ".nextmodule"
  ...
  moduleSlider.render();
  var miniSliderP1 = new _modules_slider_miniSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  miniSliderP1.innit();
  var miniSliderP3 = new _modules_slider_miniSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  miniSliderP3.innit();
  var miniSliderP5 = new _modules_slider_miniSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
    page: ".feed__slider",
  ...
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_2__["default"](".schedule .play", ".overlay").init();
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_2__["default"](".module .play", ".overlay").init();
  var form = new _modules_form__WEBPACK_IMPORTED_MODULE_3__["default"](".form");
  form.init();
  var secondForm = new _modules_form__WEBPACK_IMPORTED_MODULE_3__["default"](".scheduleForm");
  secondForm.init();
  var cardsOld = new _modules_cards__WEBPACK_IMPORTED_MODULE_4__["default"](".officerold", ".officerold .officer__card-item", ".officerold .plus");
  cardsOld.init();
  var cardsNew = new _modules_cards__WEBPACK_IMPORTED_MODULE_4__["default"](".officernew", ".officernew .officer__card-item", ".officernew .plus");
  cardsNew.init();
  var form1 = new _modules_form__WEBPACK_IMPORTED_MODULE_3__["default"]("form");
  form1.init();
...
function () {
  ...
  _createClass(Forms, [{
    ...
    value: function checkInputs() {
      document.querySelectorAll("[name='email']").forEach(function (email) {
    ...
    value: function sendForm(form) {
      ...
      form.addEventListener("submit", function (e) {
        ...
        _this.postData("assets/question.php", formData).then(function (data) {
          console.log(data);
          form.reset();
          div.textContent = _this.message.sucsess;
        }).catch(function () {
          div.textContent = _this.message.error;
        }).finally(function () {
          setTimeout(function () {
            div.remove();
          }, 4000);
...
function (_Slider) {
  ...
  function MainSlider(page, btns, slides, nextBtn, prevBtn, slideIndex) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, page, btns, slides, nextBtn, prevBtn, slideIndex));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function render() {
      ...
      if (this.page) {
        ...
        document.querySelectorAll(".prevmodule").forEach(function (btn) {
          btn.addEventListener("click", function (e) {
            _this.plusSlide(-1);
          });
        });
        document.querySelectorAll(".nextmodule").forEach(function (btn) {
          btn.addEventListener("click", function (e) {
            e.stopPropagation();
        ...
        document.querySelectorAll(".sidecontrol a:not(.next)").forEach(function (slide) {
...
function (_Slider) {
  ...
  function MiniSlider(page, slides, nextBtn, prevBtn, activeClass, animate, autoplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, page, slides, nextBtn, prevBtn, activeClass, animate, autoplay));
  }

  _createClass(MiniSlider, [{
    key: "showFirstSlide",
    value: function showFirstSlide() {
    ...
    key: "showAnotherSlides",
    value: function showAnotherSlides() {
      var _this = this;
    ...
    value: function showNextSlide() {
      ...
      this.nextBtn.addEventListener("click", function () {
        if (_this2.slides[1].tagName == "BUTTON") {
          ...
          _this2.nextBtn.click();

          _this2.nextBtn.click();

          _this2.showAnotherSlides();

          _this2.showFirstSlide();
        } else {
          _this2.page.append(_this2.slides[0]);
    ...
    value: function showPrevSlide() {
      ...
      this.prevBtn.addEventListener("click", function () {
        if (_this3.slides[_this3.slides.length - 1].tagName == "BUTTON") {
          _this3.prevBtn.click();

          _this3.prevBtn.click();

          _this3.showAnotherSlides();

          _this3.showFirstSlide();
        }

        _this3.page.prepend(_this3.slides[_this3.slides.length - 1]);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      nextBtn = _ref$nextBtn === void 0 ? null : _ref$nextBtn,
      _ref$prevBtn = _ref.prevBtn,
      prevBtn = _ref$prevBtn === void 0 ? null : _ref$prevBtn,
...
function () {
  function VideoPlayer(triggers, overlay) {
    ...
    this.closeBtn.addEventListener("click", function () {
      ...
      document.querySelector("".concat(overlay, " .video")).prepend(div);
    });
  }
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function onPlayerStateChange(event) {
      try {
        var blockedBlock = this.activeTriger.closest(".module__video-item").nextElementSibling;
    ...
    value: function init() {
      ...
      this.triggers.forEach(function (trigger) {
        trigger.addEventListener("click", function () {
          if (trigger.querySelector(".play__circle").classList.contains("closed")) {} else {
            _this2.activeTriger = trigger;
            _this2.activeSvg = trigger.querySelector("svg").cloneNode(true);
